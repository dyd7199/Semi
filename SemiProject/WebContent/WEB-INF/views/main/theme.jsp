...
<table class="table table-striped">
	...
	<tr>
		...
		<td style="font-size: 16px; width: 300px; text-align: left;"><a onclick="location.href='/detail?upso_sno=<%=list.get(i).getUpso_sno() %>'">
							이름:<%=list.get(i).getUpso_nm() %><br><br><br><a onclick="location.href='/detail?upso_sno=<%=list.get(i).getUpso_sno() %>'">
